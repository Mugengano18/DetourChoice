...
import static com.example.detourchoice.SetsActivity.category_id;
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    if (questions.isEmpty()){
                        Toast.makeText(QuestionActivity.this, "No questions in this set!!", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                    else {
                    ...
                    Toast.makeText(QuestionActivity.this, "Problemmm", Toast.LENGTH_SHORT).show();
